# Generated by Django 2.2.12 on 2020-06-20 15:55
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('article', models.CharField(max_length=7, unique=True)),
                ('model_name', models.CharField(max_length=20)),
                ('slug', models.SlugField(unique=True)),
                ('brand_name', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='catalog_items', to='crmApp.Brands')),
            ],
        ),
        migrations.CreateModel(
            name='Series',
